...
**Verification depth scales with `asvs_level`** (see @C:/Users/irfan/Downloads/RouteIQ-2.0/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
