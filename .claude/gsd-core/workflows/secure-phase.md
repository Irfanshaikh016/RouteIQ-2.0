...
```
Agent(
  prompt="Read C:/Users/irfan/Downloads/RouteIQ-2.0/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/irfan/Downloads/RouteIQ-2.0/.claude/gsd-core/templates/SECURITY.md`
